...
#print(search(r'[^A-Z]([A-Z]{3}[a-z][A-Z]{3})[^A-Z]', text).group(1))
results = findall(r'[^A-Z]([A-Z]{3}[a-z][A-Z]{3})[^A-Z]', text)
for result in results:
	print(result[3], end='') # no longer `print result[3],` - interesting
print()
